...
namespace CncPlugin_BH
{
    public class PluginPreferences
    {
        ...
        public void loadDefaults_gamepad()
        {
            IRegMemoryFolder reg = host.GetRegistryFolder("CncPlugin");

            jog_key_x_minus = reg.GetInt("jog_x_minus", 205); // LEFT
            jog_key_x_plus = reg.GetInt("jog_x_plus", 206); // RIGHT
            jog_key_y_minus = reg.GetInt("jog_y_minus", 204); // DOWN
            jog_key_y_plus = reg.GetInt("jog_y_plus", 203); // UP
            jog_key_z_minus = reg.GetInt("jog_z_minus", 212); // PGDN
            jog_key_z_plus = reg.GetInt("jog_z_plus", 211); // PGUP
            ...
            step_key_1 = reg.GetInt("step_key_1", 197); // F9
            step_key_2 = reg.GetInt("step_key_2", 198); // F10
            step_key_3 = reg.GetInt("step_key_3", 196); // F11
            step_key_4 = reg.GetInt("step_key_4", 195); // F12
            ...
            jog_unit = reg.GetString("jog_unit", "mm");
            globalkeys = reg.GetBool("globalkeys", true);
