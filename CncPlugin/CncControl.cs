...
namespace CncPlugin_BH
{
    public partial class CncControl : UserControl, IHostComponent
    {
        ...
        public void Connect(IHost _host)
        {
            ...
            host.Connection.eventResponse += Connection_eventResponse2;
        ...
        private void Connection_eventResponse2(string response, ref RepetierHostExtender.basic.LogLevel level)
        {
            // update position from analyzer
        ...
        private void Move000(object sender, EventArgs e)
        {
            String data = "G1 X0 Y0 Z0";

            host.Connection.injectManualCommand(data);

        }

        private void SetRefX0Y0(object sender, EventArgs e)
        {
            String data = "G92 X0 Y0";
